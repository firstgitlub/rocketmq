 ...
 * 这个类将在2022年被删除，建议在主动提取消息的场景中使用更好的实现defaultlitepulconsumerimpl。
 */
@Deprecated
public class DefaultMQPullConsumerImpl implements MQConsumerInner {
    ...
    public void persistConsumerOffset() {
        try {
            ...
            /**
             * OffsetStore 主要是根据 MessageModel类型，会有对应的实现类
             * 当MessageModel 是集群模式的话：RemoteBrokerOffsetStore
             * 当MessageModel 是广播模式的话：LocalFileOffsetStore
             */
