...
public class SubscriptionData implements Comparable<SubscriptionData> {
    //子Tag 意思就是如果存在当前topic下的不通tag 是否订阅全部tag
    public final static String SUB_ALL = "*";
    //在push 模式下 ，客户端接收broker push消息的时候 是否是以 classFilterMode 进行处理
    ...
    //和上面的 classFilterMode 字段配合使用，只有上面为true + filterClassSource 不为空，则才记性上传
